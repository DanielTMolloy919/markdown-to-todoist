...
import { DefaultTaskSerializer, type TaskSerializer } from "./taskIndex";
...
export const TASK_FORMATS = {
  tasksPluginEmoji: {
    ...
    buildSuggestions: makeDefaultSuggestionBuilder(
      DEFAULT_SYMBOLS,
      DEFAULT_MAX_GENERIC_SUGGESTIONS,
      false,
    ),
...
function addNewOptionsToUserSettings<KeysAndValues>(
  defaultValues: KeysAndValues,
  userValues: KeysAndValues,
) {
...
export const getSettings = (): Settings => {
  ...
  // addNewOptionsToUserSettings(
  //   defaultSettings.loggingOptions.minLevels,
  //   settings.loggingOptions.minLevels,
  // );
...
export function getUserSelectedTaskFormat(): TaskFormat {
  return TASK_FORMATS["tasksPluginEmoji"];
}
